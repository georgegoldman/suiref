...
export default function AdminEventForm() {
  ...
  const handleCreateEvent = () => {
    ...
    // Or use console.table for a nicer view:
    ...
    <div className="mx-auto max-w-[1120px] px-4 lg:px-6 py-6">
      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(300px,350px)_minmax(520px,1fr)] lg:min-h-[calc(100vh-4rem)] items-start">
        ...
        <aside className="space-y-4 lg:sticky lg:top-16 self-start">
          <ImageUploadCard selectedImage={eventImage} onImageChange={setEventImage} />
        </aside>

        {/* RIGHT: form stack (scrollable on large screens) */}
        <div
          className="lg:max-h-[calc(100vh-4rem)] lg:overflow-y-auto lg:pr-2 scrollbar-hide"
