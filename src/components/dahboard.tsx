    ...
    <div className="min-h-screen bg-[#040c33] text-white p-4 sm:p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center relative mb-8 sm:mb-12">
          <div className="w-full max-w-[200px] sm:max-w-[280px] lg:max-w-[353px]">
            <img src={WelcomeImage} className="w-full" alt="" />
          </div>
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6 sm:gap-8 lg:gap-[40px] mb-8 sm:mb-12">
          ...
          <div className="flex flex-col flex-1 gap-4 sm:gap-6 lg:gap-[30px] w-full">
            ...
            <div className="flex gap-3 sm:gap-4 lg:gap-5 w-full">
              ...
              />
              <button className="bg-[#FFFFFF] py-2.5 px-2.5 sm:px-5 rounded-[10px] h-12 sm:h-[54px] w-12 sm:w-[54px] flex items-center justify-center shrink-0">
                <CopyIcon />
              </button>
            </div>

            <button className="bg-[#FFFFFF] py-2.5 px-5 rounded-[10px] w-full h-12 sm:h-[54px] text-[#040C33] text-sm font-medium flex items-center justify-center gap-2 lg:gap-[10px]">
              <ShareIcon />
              <span>Share</span>
            </button>
          </div>
          ...
          <div className="flex items-center justify-center w-full lg:w-auto">
            ...
            <p className="mx-4 lg:mx-0 text-[#FFFFFF] font-bold text-[20px]">
              Or
            </p>
            <div className="flex-1 lg:hidden h-px bg-[#FFFFFF33]"></div>
          </div>
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="flex items-start sm:items-center space-x-3">
              <span className="text-lg sm:text-xl shrink-0">🧑‍🏫</span>
              <span className="text-sm sm:text-base text-[#FFFFFF99]">
                +1 Point → When your referral attends any workshop
              </span>
            </div>
            <div className="flex items-start sm:items-center space-x-3">
              <span className="text-lg sm:text-xl shrink-0">🏅</span>
              <span className="text-sm sm:text-base text-[#FFFFFF99]">
                Bonus rewards → When you reach referral milestones (coming
                soon!)
              </span>
            </div>
          </div>
          ...
          {ReferralData.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {ReferralData.map((data, index) => (
                ...
                >
                  <h4 className="text-sm font-medium text-[#FFFFFF99]">
                    {data.title}
                  </h4>
                  <p className="text-[#FFFFFFE5] font-medium text-xl sm:text-2xl">
                    {data.value}
                  </p>
                </div>
              ))}
            ...
            <div className="bg-[#1F5793B2] border border-[#1F5793B2] p-4 sm:p-5">
              <p className="text-center text-[#FFFFFFE5] font-medium">
