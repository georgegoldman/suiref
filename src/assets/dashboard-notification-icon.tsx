const DashboardNotificationIcon = () => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      ...
      />
      <circle cx="19" cy="5" r="5" fill="#EA4335" />
      <circle cx="19" cy="5" r="4.5" stroke="white" stroke-opacity="0.1" />
    </svg>
  );
};

export default DashboardNotificationIcon;
